...
if ( ! class_exists( 'WPPSTestSuite' ) ) {
	class WPPSTestSuite extends TestSuite {
		function __construct() {
			...
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-cryptobox-module.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-cryptobox-settings.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-cryptobox-instance-class.php' );
		}
