...
require_once( dirname( dirname( __DIR__ ) ) . '/classes/cryptobox-module.php' );

/**
 * Unit tests for the Cryptobox_Module class
 * Uses the SimpleTest For WordPress plugin
 *
 * @link http://wordpress.org/extend/plugins/simpletest-for-wordpress/
 */
if ( ! class_exists( 'UnitTestCryptobox_Module' ) ) {
	class UnitTestCryptobox_Module extends UnitTestCase {
		/*
		 * get_instance()
		 */
	...
	} // end UnitTestCryptobox_Module
}

// Mock up a child class
if ( ! class_exists( 'WPPSChildClass' ) ) {
	class WPPSChildClass extends Cryptobox_Module {
...
if ( ! class_exists( 'WPPSAnotherChildClass' ) ) {
	class WPPSAnotherChildClass extends Cryptobox_Module {
